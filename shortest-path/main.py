...
parser.add_argument('-bits', type=int, default=6, help='size of bit representation of numbers')
...
def criterion(predictions, targets):
    targets = targets(predictions.cpu().detach().numpy())
    return T.mean(
